// References: http://web.engr.oregonstate.edu/~mjb/cs575/Handouts/opencl.reduction.2pp.pdf
...
calc() {
    ...
    long double hD_sum = 0;
    for(int jj = 0; jj < GLOBAL_SIZE / LOCAL_SIZE; jj++)
        hD_sum += hD[jj];


    fprintf(stderr, "%lu,%lu,%Lf,%10.3lf\n",
            LOCAL_SIZE, GLOBAL_SIZE, hD_sum, (double) GLOBAL_SIZE / (time1 - time0) / 1000000000.);
